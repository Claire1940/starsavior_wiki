...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Terms of Service - Slayerbound Wiki',
    description: 'Read the Terms of Service for Slayerbound Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.',
    keywords: [
      'terms of service',
      'Slayerbound Wiki terms',
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: 'Terms of Service - Slayerbound Wiki',
      description: 'Terms and conditions for using Slayerbound Wiki.',
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Slayerbound Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Slayerbound Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Slayerbound Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Slayerbound Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Slayerbound". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and strategies</li>
              <li>Working codes and redemption information</li>
              <li>Character tier lists and rankings</li>
              <li>Build calculators and planning tools</li>
              <li>Combat guides and training resources</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Slayerbound Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Slayerbound. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Slayerbound Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Slayerbound. We use such
            ...
            <ul>
              ...
              <li><strong>Working Codes:</strong> Game codes may expire or become invalid at any time. We are not responsible for expired or non-functional codes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ANIME PARADOX HUB SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox.com, social media platforms,
            ...
            <p>
              ...
              you and Slayerbound Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@slayerbound.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@slayerbound.wiki</a>
            </p>
            <p>
