...
const LoadingPlaceholder = ({ height = "h-64" }: { height?: string }) => (
  <div
    className={`${height} bg-white/5 border border-border rounded-xl animate-pulse flex items-center justify-center`}
  >
    ...
    "@graph": [
      {
        ...
        description:
          ...
          "Star Savior Wiki for codes, tier list, reroll, beginner guide, characters, teams, builds, gear, news, and update tracking for the global launch.",
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        description:
          t.seo?.home?.description ||
          "Star Savior Wiki resource hub for codes, tier lists, reroll, beginner guides, and launch tracking.",
        logo: {
          "@type": "ImageObject",
          url: SITE_HERO_IMAGE,
          width: 768,
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="codes" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.codes.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.codes.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="bg-white/5 border border-border rounded-xl overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-white/5">
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.codes.table.headers.code}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.codes.table.headers.reward}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.codes.table.headers.status}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        Action
                      </th>
                  ...
                  <tbody>
                    {t.homepage.codes.table.items.map(
                      (item: any, index: number) => (
                        <tr
                          key={index}
                          className="border-b border-border hover:bg-white/5 transition"
                        >
                          <td className="px-6 py-4 font-mono font-bold text-[hsl(var(--nav-theme-light))]">
                            {item.code}
                          </td>
      ...
      {/* Star Savior Redeem Guide */}
      <section id="redeem-guide" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.redeemGuide.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.redeemGuide.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {t.homepage.redeemGuide.steps.map((step: any, index: number) => (
              <div
                key={index}
                className="relative p-6 bg-white/5 border border-border rounded-xl"
              >
      ...
      {/* Star Savior Training Paths */}
      <section id="training-paths" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.trainingPaths.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.trainingPaths.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
            {t.homepage.trainingPaths.paths.map((path: any, index: number) => (
              <div
                key={index}
                className="p-6 bg-white/5 border border-border rounded-xl hover:border-[hsl(var(--nav-theme)/0.5)] transition"
              >
      ...
      {/* Star Savior Thunder Breathing Guide */}
      <section id="thunder-breathing" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.thunderBreathing.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.thunderBreathing.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                ...
                <p className="text-muted-foreground">
                  {t.homepage.thunderBreathing.location}
                </p>
              </div>
            ...
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold">
                  {t.homepage.thunderBreathing.requirements.title}
                </h3>
              </div>
              <div className="flex flex-wrap gap-3">
                {t.homepage.thunderBreathing.requirements.items.map(
                  (item: string, index: number) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-[hsl(var(--nav-theme)/0.2)] border border-[hsl(var(--nav-theme)/0.3)] rounded-lg text-sm font-semibold"
                    >
                      {item}
                    </span>
                  ),
          ...
          <div className="scroll-reveal max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {t.homepage.thunderBreathing.steps.map(
      ...
      {/* Star Savior Fast Leveling Guide */}
      <section id="fast-leveling" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.fastLeveling.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.fastLeveling.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {t.homepage.fastLeveling.methods.map(
                (method: any, index: number) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      {method.icon === "utensils" && (
                        <Utensils className="w-8 h-8 text-[hsl(var(--nav-theme-light))]" />
                      )}
                      {method.icon === "route" && (
      ...
      {/* Star Savior Breathing Tier */}
      <section id="breathing-tier" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.breathingTier.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.breathingTier.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="scroll-reveal mt-4 inline-flex items-center gap-2 px-4 py-2 bg-[hsl(var(--nav-theme)/0.2)] border border-[hsl(var(--nav-theme)/0.3)] rounded-lg">
              ...
              <span className="text-sm">
                {t.homepage.breathingTier.dataNote}
              </span>
            </div>
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-white/5">
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.breathingTier.table.headers.breathing}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.breathingTier.table.headers.pveScore}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.breathingTier.table.headers.pvpScore}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.breathingTier.table.headers.difficulty}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.breathingTier.table.headers.cost}
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {t.homepage.breathingTier.table.items.map(
                      (item: any, index: number) => (
                        <tr
                          key={index}
                          className="border-b border-border hover:bg-white/5 transition"
      ...
      {/* Star Savior Demon Art Tier */}
      <section id="demon-art-tier" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.demonArtTier.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.demonArtTier.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="p-8 bg-white/5 border border-border rounded-xl text-center">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[hsl(var(--nav-theme)/0.2)] border border-[hsl(var(--nav-theme)/0.3)] rounded-full mb-6">
                <span className="text-sm font-semibold">
                  {t.homepage.demonArtTier.statusBadge}
                </span>
              </div>
              <p className="text-muted-foreground mb-8">
                {t.homepage.demonArtTier.emptyStateText}
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div className="p-6 bg-white/5 border border-border rounded-xl">
                  <h3 className="text-lg font-bold mb-4 text-[hsl(var(--nav-theme-light))]">
                    What We Know
                  </h3>
                  <ul className="space-y-2">
                    {t.homepage.demonArtTier.knownFacts.map(
                ...
                <div className="p-6 bg-white/5 border border-border rounded-xl">
                  ...
                  <ul className="space-y-2">
                    {t.homepage.demonArtTier.dataGaps.map(
      ...
      {/* Star Savior Oni Route */}
      <section id="oni-route" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.oniRoute.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.oniRoute.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-5xl mx-auto">
            ...
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {t.homepage.oniRoute.unknowns.map(
                  (unknown: string, index: number) => (
      ...
      {/* Star Savior Controls */}
      <section id="controls" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.controls.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.controls.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {t.homepage.controls.keys.map((control: any, index: number) => (
              <div
                key={index}
                className="p-4 bg-white/5 border border-border rounded-xl text-center hover:border-[hsl(var(--nav-theme)/0.5)] transition"
              >
      ...
      {/* Star Savior Quest Map */}
      <section id="quest-map" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.questMap.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.questMap.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
      ...
      {/* Star Savior Final Selection */}
      <section id="final-selection" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.finalSelection.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.finalSelection.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-4xl mx-auto mb-8">
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              <p className="text-muted-foreground">
                {t.homepage.finalSelection.overview}
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  {t.homepage.finalSelection.details.location}
                </p>
              </div>
              ...
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  {t.homepage.finalSelection.details.timing}
                </p>
              </div>
              ...
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  {t.homepage.finalSelection.details.maxPlayers}
                </p>
              </div>
              ...
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  {t.homepage.finalSelection.details.difficulty}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold">
                    {t.homepage.finalSelection.rewards.title}
                  </h3>
                </div>
                <ul className="space-y-2">
                  {t.homepage.finalSelection.rewards.items.map(
                    (item: string, index: number) => (
                      <li
                        key={index}
                        className="flex items-start gap-2 text-sm"
              ...
              <div className="p-6 bg-white/5 border border-border rounded-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold">
                    {t.homepage.finalSelection.tips.title}
                  </h3>
                </div>
                <ul className="space-y-2">
                  {t.homepage.finalSelection.tips.items.map(
                    (item: string, index: number) => (
                      <li
                        key={index}
                        className="flex items-start gap-2 text-sm"
      ...
      {/* Star Savior Boss Drops */}
      <section id="boss-drops" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.bossDrops.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.bossDrops.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-5xl mx-auto mb-6">
            <div className="p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl flex items-start gap-3">
              ...
              <p className="text-sm text-yellow-400">
                {t.homepage.bossDrops.riskNotice}
              </p>
            </div>
          </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-white/5">
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.bossDrops.table.headers.drop}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.bossDrops.table.headers.source}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.bossDrops.table.headers.howToObtain}
                      </th>
                      <th className="px-6 py-4 text-left font-semibold">
                        {t.homepage.bossDrops.table.headers.primaryUse}
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {t.homepage.bossDrops.table.items.map(
                      (item: any, index: number) => (
                        <tr
                          key={index}
                          className="border-b border-border hover:bg-white/5 transition"
      ...
      {/* Star Savior Currency Farm */}
      <section id="currency-farm" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.currencyFarm.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.currencyFarm.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-5xl mx-auto mb-6">
            <div className="p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl text-center">
              <p className="text-sm text-yellow-400">
                {t.homepage.currencyFarm.disclaimer}
              </p>
            </div>
          </div>
      ...
      {/* Star Savior Reset Planner */}
      <section id="reset-planner" className="px-4 py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.resetPlanner.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.resetPlanner.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="p-8 bg-white/5 border border-border rounded-xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold mb-2">
                  {t.homepage.resetPlanner.startQuestion}
                </h3>
              </div>

              <div className="space-y-6">
                {t.homepage.resetPlanner.decisions.map(
                  (decision: any, index: number) => (
                    <div
                      key={index}
                      className="p-6 bg-white/5 border border-border rounded-xl"
                    >
                      <h4 className="font-bold mb-4 text-[hsl(var(--nav-theme-light))]">
                        {decision.question}
                      </h4>
      ...
      {/* Star Savior Build Planner */}
      <section id="build-planner" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.buildPlanner.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.buildPlanner.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
            ...
            <div className="scroll-reveal mt-4 inline-flex items-center gap-2 px-4 py-2 bg-[hsl(var(--nav-theme)/0.2)] border border-[hsl(var(--nav-theme)/0.3)] rounded-lg">
              ...
              <span className="text-sm">
                {t.homepage.buildPlanner.dataNote}
              </span>
            </div>
          </div>
          ...
          <div className="scroll-reveal max-w-5xl mx-auto">
            <div className="p-8 bg-white/5 border border-border rounded-xl mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {t.homepage.buildPlanner.inputFields.map(
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {t.homepage.buildPlanner.presetExamples.map(
      ...
      {/* Star Savior Clan System */}
      <section id="clan-system" className="px-4 py-20 bg-white/[0.02]">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="scroll-reveal text-4xl md:text-5xl font-bold mb-4">
              {t.homepage.clanSystem.title}{" "}
              <span className="text-[hsl(var(--nav-theme-light))]">
                {t.homepage.clanSystem.titleHighlight}
              </span>
            </h2>
            <p className="scroll-reveal text-muted-foreground text-lg">
          ...
          <div className="scroll-reveal max-w-4xl mx-auto mb-8">
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              <p className="text-muted-foreground">
                {t.homepage.clanSystem.overview}
              </p>
            </div>
          </div>
            ...
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold">
                  {t.homepage.clanSystem.notableClans.title}
                </h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {t.homepage.clanSystem.notableClans.clans.map(
                  (clan: any, index: number) => (
                    <div
                      key={index}
                      className="p-4 bg-white/5 border border-border rounded-xl"
                    >
                      <h4 className="font-bold text-[hsl(var(--nav-theme-light))] mb-2">
                        {clan.name}
                      </h4>
          ...
          <div className="scroll-reveal max-w-4xl mx-auto">
            <div className="p-6 bg-white/5 border border-border rounded-xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold">
                  {t.homepage.clanSystem.howToSpin.title}
                </h3>
              </div>
              <ol className="space-y-2">
                {t.homepage.clanSystem.howToSpin.steps.map(
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link
                    href={`${legalPrefix}/terms-of-service`}
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
