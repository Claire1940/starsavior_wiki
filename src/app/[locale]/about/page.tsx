...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Slayerbound Wiki - Your Ultimate Roblox Game Resource',
    description: 'Learn about Slayerbound Wiki, a community-driven resource hub providing comprehensive guides, codes, tier lists, and strategies for the Slayerbound Roblox game.',
    keywords: [
      'about Slayerbound Wiki',
      'Slayerbound community',
      'Roblox game wiki',
      'game resource hub',
      'Slayerbound team',
    ],
    ...
    openGraph: {
      ...
      title: 'About Slayerbound Wiki',
      description: 'Learn about our mission to provide the best Slayerbound game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Slayerbound Wiki',
      description: 'Learn about our mission to provide the best Slayerbound game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Slayerbound
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Slayerbound Wiki</h2>
            <p>
              Slayerbound Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Roblox game "Slayerbound". We are a community-driven platform that provides the latest codes,
            ...
            <p>
              ...
              Slayerbound Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Slayerbound players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Slayerbound Wiki as the <strong>go-to destination</strong> for every Slayerbound player seeking
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                ...
                Your one-stop encyclopedia for all things Slayerbound.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Slayerbound Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Slayerbound Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Slayerbound as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Slayerbound mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Slayerbound Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with Roblox Corporation or the developers of Slayerbound.
            </p>
            <p>
            ...
            <p>
              Slayerbound Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@slayerbound.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@slayerbound.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@slayerbound.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@slayerbound.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@slayerbound.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@slayerbound.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@slayerbound.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@slayerbound.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest codes, guides, and Slayerbound news.
